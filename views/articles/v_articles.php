        ...
        <article class="post">
            ...
            <div class="post__body">
                <div class="post__content">
                    <h2 class="post__title"><a href="<?= BASE_URL ?>article/<?= $article['url_art'] ?>"> <?= $article['title'] ?></a></h2>
                ...
                <div class="post__footer">
                    ...
                    <a class="post__read" href="<?= BASE_URL ?>article/<?= $article['url_art'] ?>">Читать дальше</a>
                </div>
